          ...
          <form action="/manufacturers" method="POST">
            ...
            <div class="form-group row">
              <div class="col-sm-12">
                ...
                <input name="distributor_login" type="url" value="" class="form-control input-group" id="inlineFormInput" placeholder="http://www.manufacturer-website.com">
              </div>
            </div>
            ...
            <div class="form-group row">
              <div class="col-sm-12">
                <label class="sr-only" for="inlineFormInput">Website</label>
                <input name="web" type="url" value="" class="form-control input-group" id="inlineFormInput" placeholder="http://www.distributor-extranet.com">
              </div>
            </div>
